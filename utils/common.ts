...
description:
  ...
  main_skills: [
    ...
    { id: 12, title: "Github", exp: "2y+" },
    { id: 13, title: "Redux", exp: "2y+" },
    { id: 7, title: "Prisma", exp: "2y+" },
    { id: 14, title: "REST Full API", exp: "3y+" },
    { id: 15, title: "PostgreSQL", exp: "2y+" },
    { id: 10, title: "JavaScript", exp: "4y+" },
  ],
  others_skills: [
    { id: 2, title: "Git & GitHub" },
    { id: 6, title: "Docker" },
    { id: 7, title: "Linux (Basic CLI)" },
    { id: 8, title: "JWT Authentication" },
